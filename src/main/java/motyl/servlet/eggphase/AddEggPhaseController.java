...
/**
 * Servlet implementation class AddEggPhaseController
 */
@WebServlet("/add_egg.controller")
public class AddEggPhaseController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			eggphasedao.insertEggLote(eggLote);
