...
/**
 * Servlet implementation class AddLarvaPhaseController
 */
@WebServlet("/add_larva.controller")
public class AddLarvaPhaseController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			// execute insert Larva Lote
			larvaphasedao = new LarvaPhaseDAO();
			larvaphasedao.insertLarvaLote(larvaLote);
